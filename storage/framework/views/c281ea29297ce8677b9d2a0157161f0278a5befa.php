        ...
        <div class="row mt-4">
            <div class="media">
                <button type="button" data-toggle="modal" data-target="#myModal">
                    <img class="d-flex align-self-center mr-3" src="<?php echo e(asset('images/The_Legend_of_Zelda_Breath_of_the_Wild.jpg')); ?>" alt="Game placeholder image" width = "150px"/>
                </button>
                <!-- Modal -->
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <img src="<?php echo e(asset('images/The_Legend_of_Zelda_Breath_of_the_Wild.jpg')); ?>" width="100%"/>
                            </div>
                        </div>
                    </div>
                </div>
